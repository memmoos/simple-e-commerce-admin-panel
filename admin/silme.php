...
<div class="container">
        ...
        <div class="content">
            <?php
                ...
                echo "<tr><th>Resim</th><th>Id</th><th>Adı</th><th>Türü</th><th>Markası</th><th>Fiyatı</th><th>Adeti</th><th>Açıklaması</th><th>Sil</th></tr>";
                ...
                while ($cikcik=$sorgu->fetch(PDO::FETCH_ASSOC))
                {
                    ...
                    echo "<td><a href='sil.php?&urId=" . $cikcik['urunId'] . "&urResim=".$cikcik['resim_adi']."'>Sil</a></td>";
                }
                echo "</td></tr></table>";
                }
